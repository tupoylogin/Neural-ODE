...
def OdeintAdjointMethod(*args):
    ...
    def grad(*grad_output, variables=None):
        ...
        # TODO: use a keras.Model and call odeint_adjoint to implement higher order derivatives.
        def augmented_dynamics(t, y_aug):
            # Dynamics of the original system augmented with
            # the adjoint wrt y, and an integrator wrt t and args.
            # get y and adj_y
            y, _ = y_aug[:n_tensors], y_aug[n_tensors:2 * n_tensors]  # Ignore adj_time and adj_params.
